...
Легковесная библиотека без зависимостей для управления cookie-согласиями на сайте. Поддерживает категории cookies (обязательные, маркетинговые, функциональные), включает адаптивный баннер и модальное окно настроек, предоставляет API для проверки разрешений, умеет обходить блокировщики и использует ленивую инициализацию.
...
Для проектов на Bitrix используйте отдельную инструкцию: [BITRIX.md](BITRIX.md).
